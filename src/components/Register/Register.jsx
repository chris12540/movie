    ...
    return (
      <div className="register">
        <div className="register-inner">
          <p className={!filledOut ? "filledOut" : "none"}>
            Fill out all fields
          </p>
          <input
            value={name}
          ...
          <input
            ...
            className="input"
          />
          <p className={usernameTaken ? "usernameTaken" : "none"}>
            Username taken
          </p>
          <input
            value={password}
          ...
          <input
            value={password2}
            onChange={(e) => {
              this.update("password2", e.target.value);
            }}
            placeholder="Re-Type Password"
            type="password"
            className="input"
          />
          <p className={!passwordsMatch ? "passwordsMatch" : "none"}>
